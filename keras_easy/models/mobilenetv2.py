from keras.applications.mobilenetv2 import MobileNetV2 as KerasMobileNetV2
...
class MobileNetV2(BaseModel):
    ...
    def _create(self):
        base_model = KerasMobileNetV2(include_top=False, input_tensor=self.get_input_tensor())
